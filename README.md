...
```
# 32-bit
wget https://archive.org/download/exagear-desktop_202111/exagear_3428-1_armhf.deb --no-check-certificate
wget https://archive.org/download/exagear-desktop_202111/exagear-dsound-server_010_armhf.deb --no-check-certificate
...
```
wget https://archive.org/download/exagear-desktop_202111/patch.sh --no-check-certificate
sudo bash patch.sh
```
